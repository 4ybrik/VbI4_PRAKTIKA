...
////A[m,j] = tmp;
////n--;
//	for(int k = 0; k < n/*maxLenStolbec*/;k++) {
//for(int p = i ; p < m/*maxLenStroka*/;p++) {
//int tmp = A[m-1,k];
//A[m-1,k] = A[p,k];
//A[p,k] = tmp;
//}
...
//int cc = 0;
//int counter = 0;
//for(int i = 0; i < n/*maxLenStolbec*/; i++) {
//
//if (A[0,i] == 0) {
//for(int j = 0; j < m/*stolbec*/; j++) {
//if (A[j,i] != 0) {
//flag1 = false;
//break;
//}
...
//if (flag1) {
//for(int k = 0; k < n/*maxLenStolbec*/;k++) {
//for(int p = i - cc; p < m/*maxLenStroka*/ - cc;p++) {
//int tmp = A[k,m-1];
//A[k,m-1] = A[k,p];
//A[k,p] = tmp;
//}
...
int max_sum=0;
	...
	/*int zeroCounterColumns_counter=0;
	for(int i=0;i<n;i++){

		zeroCounterColumns=0;
		for(int j=0;j<m;j++){
			if(A[j,i]==0){
				zeroCounterColumns+=1;
				if(zeroCounterColumns==n){
					zeroCounterColumns_counter+=1;
					for(int k=0;k<n;k++){
						t=A[k,i];
						A[k,i]=A[k,m-1];
						A[k,m-1]=t;
	...
	//textBox2->Lines=as;
	//	}
	//	else if(A[m-t,n-z]==0 && A[0,n-z]==0){
	//		for(i=0;i<n-i+1/*-zeroCounterRows_counter*/;i++){
	//	s="";
	//	for(j=0;j<m-i/*-zeroCounterColumns_counter+1*/;j++)
	//	s+=A[i,j].ToString()+" ";
	//	//s+="\n";
	//	//textBox2->Lines[i]=s;
	//	as[i]=s;
...
//	textBox2->Lines=as; 
//		}
//		else if(A[m-t,n-z]==0 && A[m-t,0]==0){
//			for(i=0;i<n-i/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m-i+1/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
//		//s+="\n";
//		//textBox2->Lines[i]=s;
//		as[i]=s;
...
//		}
//	else if(A[m-1,n-1]!=0){
//	for(i=0;i<n/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
//		//s+="\n";
//		//textBox2->Lines[i]=s;
//		as[i]=s;
...
//}
	...
	//
//if(A[m-4,n-4]==0){
//	for(i=0;i<n-4/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m-4/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
//		//s+="\n";
//		//textBox2->Lines[i]=s;
//		as[i]=s;
...
//	textBox2->Lines=as;
//}
//else if(A[m-2,n-2]==0 && A[0,n-2]==0 && A[m-2,0]==0 ){
//	for(i=0;i<n-2/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m-2/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
//		//s+="\n";
//		//textBox2->Lines[i]=s;
//		as[i]=s;
...
//	textBox2->Lines=as;
//}
//else if(A[m-2,n-2]==0 && A[0,n-2]==0){
//	for(i=0;i<n-1/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m-2/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
//		//s+="\n";
...
//	textBox2->Lines=as;
//}
//else if(A[m-2,n-2]==0 && A[m-2,0]==0){
//	for(i=0;i<n-2/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m-1/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
//		//s+="\n";
//		//textBox2->Lines[i]=s;
//		as[i]=s;
...
//	textBox2->Lines=as;
//}
//else if(A[m-1,n-1]==0 && A[0,n-1]==0 && A[m-1,0]==0 ){
//	for(i=0;i<n-1/*-zeroCounterRows_counter*/;i++){
//		s="";
//		for(j=0;j<m-1/*-zeroCounterColumns_counter+1*/;j++)
//		s+=A[i,j].ToString()+" ";
