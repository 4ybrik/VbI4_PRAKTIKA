...
namespace THIRD_VbI4_PRAKTIKA_2 {
...
//Рисование поверхности
	...
	//Рисуем и подписываем ось z
		...
		for(j3=-30;j3<30;j3++){
			for(i3=-48;i3<20;i3++){
				IJ(h0+h*i3,h0+h*j3,F1(h0+h*i3,h0+h*j3,2.5,2.5),a1);
				ob[0].X=a1[0];
				ob[0].Y=a1[1];
				IJ(h0+h*i3,h0+h*(j3+1),F1(h0+h*i3,h0+h*(j3+1),2.5,2.5),a1);
				ob[1].X=a1[0];
				ob[1].Y=a1[1];
				IJ(h0+h*(i3+1),h0+h*(j3+1),F1(h0+h*(i3+1),h0+h*(j3+1),2.5,2.5),a1);
				ob[2].X=a1[0];
				ob[2].Y=a1[1];
				IJ(h0+h*(i3+1),h0+h*j3,F1(h0+h*(i3+1),h0+h*j3,2.5,2.5),a1);
				ob[3].X=a1[0];
				ob[3].Y=a1[1];
